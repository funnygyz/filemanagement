...
/*     public function getAuthor()
    ...
    public static function RecentlyPost($limit=10)
    {
        return Post::find()->orderBy('create_time DESC')
        ->limit($limit)->all();
    }
    ...
    {
        return Yii::$app->urlManager->createUrl(
                ['post/view','id'=>$this->id,'title'=>$this->title]);
    }

    public function getUrldown()
    {
        return Yii::$app->urlManager->createUrl(
                ['post/export','id'=>$this->id,'title'=>$this->title]);
    }
